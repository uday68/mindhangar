...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      className={`rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 ${variants[variant]} ${sizes[size]} ${widthClass} ${disabledClass} ${className}`}
